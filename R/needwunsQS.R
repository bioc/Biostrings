...
XString.needwunsQS <- function(s1, s2, substmat, gappen)
{
    ...
    new("XStringAlign",
        align1=align1, align2=align2, patternQuality=BString(""),
        subjectQuality=BString(""), type="global", score=C_ans$score,
        constantMatrix=substmat, gapOpening=0, gapExtension=gappen)
}
